...
public class NhanVien_GUI extends JFrame implements ActionListener, MouseListener {
	...
	private void docDuLieuDataBaseVaoTable() {
		...
		for(nhanVien nv : list) {
			modelNhanVien.addRow(new Object[] {nv.getMaNV(), nv.getHoNV(), nv.getTenNV(), nv.getTuoi(), nv.isPhai(), nv.getLuong(), nv.getPhong().getTenPhong()});
	...
	private void addAction() {
		...
		nhanVien nv = new nhanVien(ma, ho, ten, tuoi, phai, luong, new entity.phongBan(phongBan));
		
		try {
			String gioiTinh = phai == true ? "Nu" : "Nam";
			nv_dao.creatNhanVien(nv);
